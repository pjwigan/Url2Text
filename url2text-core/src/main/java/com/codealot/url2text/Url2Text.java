...
public class Url2Text
{
     ...
     * @throws Url2TextException
     */
    private void invokeTika(final Url2TextResponse response, final Page page)
            throws Url2TextException
    {
        try
        {
